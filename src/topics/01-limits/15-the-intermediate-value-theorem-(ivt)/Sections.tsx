...
const Section10 = <>
  ...
  <div>
    For example, consider the function <Latex expression={`g(x) = \\frac{1}{x}`} />. Does the IVT guarantee a value <Latex expression="c" /> on <Latex expression="[-2, 2]" /> such that <Latex expression="g(c) = 0" />?
  </div>
</>
